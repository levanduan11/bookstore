	...
	<main class="bg-light" style="padding: 50px 200px;" class="bg-dark text-white"
		...
		<h2>
			<c:choose>
				...
				<c:otherwise>Create new customer</c:otherwise>
			</c:choose>
		</h2>
		<div>
			<c:choose>
			...
			<table align="center">
				...
				<tr>
					...
					<td><input
						...
						type="password" name="password" size="50" value="${customer.password}"></td>
				</tr>
				<tr>
					<td>confirm password:</td>
					<td><input
						style="margin: 10px; padding: 5px; border-radius: 5px;" id="confirmpassword"
						type="password" name="confirmpassword" size="50" value="${customer.password}"></td>
				</tr>
				...
				<tr>
					...
					<td><input
						...
						type="text" name="phone" size="50" value="${customer.phone}"></td>
				</tr>
				<tr>
					<td>address </td>
					<td><input
						style="margin: 10px; padding: 5px; border-radius: 5px;" id="address"
						type="text" name="address" size="50" value="${customer.address}"></td>
				</tr>
				<tr>
					<td>city</td>
					<td><input
						style="margin: 10px; padding: 5px; border-radius: 5px;" id="city"
						type="text" name="city" size="50" value="${customer.city}"></td>
				</tr>
				<tr>
					<td>zipcode </td>
					<td><input
						style="margin: 10px; padding: 5px; border-radius: 5px;" id="zipcode"
						type="text" name="zipcode" size="50" value="${customer.zipcode}"></td>
				</tr>
				<tr>
					<td>country</td>
					<td><input
						style="margin: 10px; padding: 5px; border-radius: 5px;" id="country"
						type="text" name="country" size="50" value="${customer.country}"></td>
				</tr>
